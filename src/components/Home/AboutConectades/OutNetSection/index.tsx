...
export function OutNetSection() {
    return (
        <Container classCss={`flex flex-col items-center gap-8 ${styles.aboutConectadesContainer}`}>
            <div className={styles.outNetSection}><Title.Level2 text="Valorizamos a rede fora da rede" />
            ...
            </div><Image src={people} alternateText="Ilustração de pessoas diversas de mãos dadas e sorrindo" className={styles.image} />
        </Container>
    );
}