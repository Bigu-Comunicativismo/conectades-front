...
export const Route = createFileRoute('/campaigns/_Campaign/$id')({
    ...
    loader: async ({ params }) => {
        ...
        const campaignFetched: CampaignFetched = await apiFetch<CampaignFetched>({ apiPath: `http://srv1037558.hstgr.cloud:8001/api/campanhas/${campaignId}` })
        .catch(() => {
